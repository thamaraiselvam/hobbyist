...
void main() {
  ...
  group('AnalyticsService Tests', () {
    ...
    test('logScreenView', () async {
      ...
      verify(
        mockAnalytics.logScreenView(screenName: 'Home', screenClass: 'Home'),
      ).called(1);
    });
    ...
    test('Hobby Management Events', () async {
      ...
      verify(
        mockAnalytics.logEvent(
          name: 'hobby_updated',
          parameters: argThat(
            containsPair('repeat_mode', 'weekly'),
            named: 'parameters',
          ),
        ),
      ).called(1);
    ...
    test('User Engagement Metrics', () async {
      ...
      verify(
        mockAnalytics.setUserProperty(name: 'prop', value: 'val'),
      ).called(1);
