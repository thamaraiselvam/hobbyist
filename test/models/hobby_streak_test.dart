  ...
  group('Hobby Streak Calculations', () {
    ...
    test('currentStreak should be 5 for 5 consecutive days including today', () {
      ...
      for (int i = 0; i < 5; i++) {
        ...
        completions[dateKey] = HobbyCompletion(completed: true, completedAt: date);
      }
    ...
    test('currentStreak should reset when there is a gap', () {
      ...
      completions[threeDaysAgoKey] = HobbyCompletion(completed: true, completedAt: threeDaysAgo);
    ...
    test('calculateBestStreakFromHistory should return 0 when no completions', () {
      final hobby = Hobby(
        id: '1',
        name: 'Test',
        color: 0xFF6C3FFF,
    ...
    test('calculateBestStreakFromHistory should return 1 for single completion', () {
      final today = DateTime.now();
      final todayKey = '${today.year}-${today.month.toString().padLeft(2, '0')}-${today.day.toString().padLeft(2, '0')}';
    ...
    test('calculateBestStreakFromHistory should return 5 for 5 consecutive days', () {
    ...
    test('calculateBestStreakFromHistory should find max streak across multiple streaks', () {
      final baseDate = DateTime(2026, 1, 1);
      final completions = <String, HobbyCompletion>{};
    ...
    test('calculateBestStreakFromHistory should handle ongoing streak as the best', () {
      final today = DateTime.now();
      final completions = <String, HobbyCompletion>{};
    ...
    test('bestStreak should always be >= currentStreak', () {
      ...
      final trueBest = [hobby.bestStreak, historicalBest, currentStreak]
          .reduce((a, b) => a > b ? a : b);
      
      expect(trueBest >= currentStreak, true,
          reason: 'Best streak ($trueBest) should be >= current streak ($currentStreak)');
      expect(trueBest, 5);
    });
  });
}
